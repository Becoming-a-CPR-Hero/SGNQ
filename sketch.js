...
const scriptURL = "https://script.google.com/macros/s/AKfycbyPz-C6Y1jgHc96q_k_NqSktpVdGsqHPmp0FxH1h5N2GT7crTUwkWk1dNl07hAFgaM9xQ/exec";
...
window.onload = () => {
    ...
    const handleNameNext = () => {
        ...
        // Pre-questionnaire (preq1-6) skipped in this version — go
        // straight from name entry to the start of the mission.
    ...
    const handleNextWin = () => {
        ...
        // Post-questionnaire (postq1-7) skipped in this version.
        logSession();
        showPromiseScreen();
    };
